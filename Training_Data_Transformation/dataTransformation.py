...
class Data_Transformation:
    ...
    """
    def __init__(self):
        self.file_path = "Executions_Logs/Training_Logs/Data_Tansformation_Logs.txt"  # this file path help to log the details in particular file = Executions_Logs/Training_Logs/Data_Tansformation_Logs.txt
