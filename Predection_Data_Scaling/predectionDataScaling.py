...
class Predection_Data_Scaling:
    ...
    """
    def __init__(self):
        self.file_path = "Executions_Logs/Predection_logs/Data_Scaling_Logs.txt"   # this file path help to log the details in particular file
