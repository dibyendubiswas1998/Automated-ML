...
class Predection_Feature_Engineerings:
    """
         This class shall be used for handle the raw data for predection.
    ...
    """
    def __init__(self):
        self.file_path = "Executions_Logs/Predection_logs/Features_Engineering_Logs.txt"   # this file path help to log the details in particular file
